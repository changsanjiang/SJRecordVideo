//
//  DBPublishSelectRecordTimeView.m
//  dancebaby
//
...
@interface DBPublishSelectRecordTimeView ()
...
@implementation DBPublishSelectRecordTimeView
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if ( !self ) return nil;
    [self _DBPublishSelectRecordTimeViewSetupUI];
    return self;
}
...
- (void)_DBPublishSelectRecordTimeViewSetupUI {
